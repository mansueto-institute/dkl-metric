...
### TAKES A MINUTE
ggsave(plot = map_combo, filename = paste0(wd_dev,'/outputs/',city_name,' Maps.png'), height = 18, width = 18, dpi = 300)
...
ggsave(plot = p_dots, filename = paste0(wd_dev,'/outputs/',city_name,' Dots.png'), height = 5.5, width = 7)
ggsave(plot = p_dots_demos, filename = paste0(wd_dev,'/outputs/',city_name,' Dots Demos.png'), height = 4, width = 10)
ggsave(plot = p_demos, filename = paste0(wd_dev,'/outputs/',city_name,' Demos.png'), height = 4, width = 7)
